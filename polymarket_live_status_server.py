...
def _load_strategy_state() -> dict:
    ...
    try:
        ...
        return {
            ...
            "windowDiagnostics": [strategy.sim.decision_diag.public_summary(x)
                                  for x in state.get("windowDiagnostics", [])[:20]],
        }
...
def _fetch_state() -> dict:
    ...
    return {
        ...
        "strategyConfig": {
            ...
            "lateFavoriteEnabled": strategy.LATE_FAVORITE_ENABLED,
            "lateFavoriteWindowSeconds": strategy.LATE_FAVORITE_WINDOW_SECONDS,
            ...
            "lateFavoriteMinSignalDeltaPct": strategy.LATE_FAVORITE_MIN_SIGNAL_DELTA_PCT,
            ...
            "stabilitySeconds": strategy.PAIR_STABILITY_SECONDS,
            "rescueLockMaxSum": strategy.RESCUE_LOCK_MAX_SUM,
